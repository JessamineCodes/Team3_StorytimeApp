...
# Function to create paragraph two of the story using child's name, dinosaur species and random elements
...
def paragraph_two(child_name, dino_species):
    ...
    option_one = f"{child_name} found themselves in a prehistoric jungle where it was {rand_weather}. They could hear the {dino_species} roaring in the distance. They ran towards the sound and saw the {dino_species} lying on the ground. It had a huge gash on its side! {child_name} opened the medikit and took out a bandage. They wrapped the bandage around the {dino_species}'s wound and gave it a painkiller. The {dino_species} slowly got to its feet and roared in gratitude."
...
# Function to create paragraph three of the story using child's name, dinosaur species, dinosaur description and random elements.
