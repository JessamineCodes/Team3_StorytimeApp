...
def paragraph_two(child_name, child_pronouns):
    ...
    option_one = f"An unidentified lifeform has got stuck in the airlock of the ship - they need someone to come get it from the outside. {child_name} bravely pulled on {pronouns[child_pronouns]['possessive']} space suit and jumped in a rocket. In space, {child_name} parked {pronouns[child_pronouns]['possessive']} ship next to the ISS and went on a spacewalk to investigate the airlock. The outer door was wide open, and when {child_name} peeked inside {pronouns[child_pronouns]['subject']} saw a cute little {alien_desc}. One of the tentacles of the alien was trapped in one of the {rand_spaceship_part} and it was crying. Luckily {child_name} knew just what to do, and brought out a pack of space butter. After rubbing the tentacle in butter it slipped straight out! The alien cuddled up to {child_name} and then ate all the butter."

    option_two = f"The ISS's engine was failing! And they needed someone to bring them a special space screwdriver to fix it, as theirs got lost on the last spacewalk. {child_name} bravely pulled on {pronouns[child_pronouns]['possessive']} space suit and jumped in a rocket. As {child_name} approached the ISS {pronouns[child_pronouns]['subject']} realised {pronouns[child_pronouns]['subject']} had left the screwdriver back on Earth! Oh no! But just then {pronouns[child_pronouns]['subject']} heard a {rand_noise}. {child_name} looked around and saw an alien in a shiny flying saucer. The alien was huge and {alien_desc}. To {child_name}'s surprise and relief, the alien was waving a space screwdriver! {child_name} borrowed the screwdriver, and with the alien's help managed to fix the engine just before it exploded!"
...
def paragraph_three(child_name):
    ...
    return f"From that day on they were best friends! {child_name} called the alien {rand_alien_name} and they lived together on the ISS with the other {no_iss_residents} astronauts. They all had space ice cream parties every weekend and got to explore the universe together!"

# Method for creating the full story using all three paragraphs, takes child name and age as inputs
def space_story_text(child_name, child_age, child_pronouns):
